...
using HackathonProject_MV.Data;
using HackathonProject_MV.Models;

namespace HackathonProject_MV.Controllers
{
    public class AccountsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Amount,AccountType")] Account account)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Amount,AccountType")] Account account)
        {
            if (id != account.Id)
            {
                return NotFound();
